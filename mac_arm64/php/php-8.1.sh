...
PREFIX=${PREFIX:-/Applications/EServer/childApp/php/php-8.1}
PHP_VERSION=${PHP_VERSION:-8.1.31}
...
sudo cp ./php.ini-development /Applications/EServer/childApp/php/php-8.1/etc/php.ini-development
sudo cp ./php.ini-production /Applications/EServer/childApp/php/php-8.1/etc/php.ini-production
